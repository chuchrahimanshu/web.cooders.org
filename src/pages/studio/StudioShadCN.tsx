...
import { StudioLayoutOnlyItems } from "../../components";
      ...
      <div className="bg-primary-overlay w-[240px] h-[calc(100vh-110px)] rounded-[10px] px-2 pb-2 pt-[6px] flex flex-col">
        ...
        {selectedTab === 0 && (
          <StudioLayoutOnlyItems
            data={STUDIO_DATA?.STUDIO_COMPONENTS?.SHADCN_COMPONENTS}
          />
        )}
      </div>
    </section>
