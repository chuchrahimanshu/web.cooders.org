    ...
    <React.Fragment>
      {users && users.length > 0 && (
        <section className="w-[240px] bg-primary-overlay rounded-[10px]">
          ...
          <div className="h-[170px] overflow-y-scroll hide-scrollbar my-1">
            {users.map((user) => (
              <section className="flex justify-between items-center px-3 p-2 hover:bg-secondary-overlay ease-in-out duration-300 cursor-pointer rounded-[10px] mx-1">
                ...
                <div className="flex items-center gap-2 -mr-1">
                  <MdDone
                    size={22}
                    className="text-white/60 hover:text-palette-sky ease-in-out duration-300 cursor-pointer"
                  />
                  <MdClose
                    size={22}
                    className="text-white/60 hover:text-palette-sky ease-in-out duration-300 cursor-pointer"
